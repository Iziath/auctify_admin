...
class FloreWidget extends StatefulWidget {
  const FloreWidget({super.key});

  @override
  State<FloreWidget> createState() => _FloreWidgetState();
}

class _FloreWidgetState extends State<FloreWidget> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Padding(
              padding: EdgeInsets.all(Consts.defaultPadding),
              child: Text("ESPÈCES DE LA FLORE", style: Consts.titleStyle),
            ),
            Padding(
                    ...
                    ...[1, 2, 3, 4, 5, 6, 7, 8].map(
                      (e) => DataRow(
                        cells: [
                          ...
                          const DataCell(Text("e.lastName")),
                          const DataCell(Text("e.firstName")),
                          const DataCell(Text("e.gender")),
                          const DataCell(Text("e.email")),
                          const DataCell(Text("e.phone")),
                          const DataCell(Text("e.adress")),
                          DataCell(
                            Row(
                              children: [
                                IconButton(
